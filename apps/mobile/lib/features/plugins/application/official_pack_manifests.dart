...
const officialPackManifestMaps = <String, Map<String, Object?>>{
  'pack.default': <String, Object?>{
    ...
    'marketplace': <String, Object?>{
      ...
      'capabilities': <String>['memory.propose', 'card.write'],
      'status': 'available',
    },
    ...
    'agents': <Map<String, Object?>>[
      <String, Object?>{
        ...
        'output_events': <String>['wn.card.created', 'wn.memory.proposed'],
    ...
    'model_profiles': <Map<String, Object?>>[
      <String, Object?>{
        ...
        'purpose': 'Summarize captures into cards and Memory candidates.',
        'required': false,
      },
    ],
