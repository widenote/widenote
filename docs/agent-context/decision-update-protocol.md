...
5. Update `docs/agent-context/project-map.md` if the decision changes repository structure.
6. Update `docs/agent-context/START_HERE.md` if the decision changes onboarding context.
