...
path in `AGENTS.md`: operational principles when a cross-cutting trigger
matches, current contracts, project map when needed, nearest module README, then
related ADRs or RFCs only when the task calls for them.

Broad orientation path:

1. `README.md`
2. `docs/architecture/operational-principles.md`
3. `docs/architecture/current-contracts.md`
4. `docs/decisions/index.md`
5. `docs/product/positioning.md`
6. `docs/architecture/overview.md`
7. `docs/architecture/context-structure.md`
8. `docs/architecture/project-structure.md`
9. `docs/architecture/engineering-rules.md`
10. `docs/agent-context/project-map.md`
11. `docs/agent-context/open-questions.md`
12. `widenote_project_brief.md` when deeper product context is needed
...
Use `docs/architecture/operational-principles.md` for cross-cutting preflight
triggers. Use `docs/architecture/current-contracts.md` for the current
target-state contracts agents should maintain by default. Use ADRs and RFCs for
decision history, tradeoffs, provenance, or when changing a contract.
